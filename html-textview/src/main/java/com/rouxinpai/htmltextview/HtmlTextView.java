...
public class HtmlTextView extends JellyBeanSpanFixTextView {
    ...
    public int blockQuoteBackgroundColor = getResources().getColor(R.color.html_textview_white);
    public int blockQuoteStripColor = getResources().getColor(R.color.html_textview_black);
    ...
    /**
     * @see com.rouxinpai.htmltextview.HtmlTextView#setHtml(int)
     */
    ...
    /**
     * @see com.rouxinpai.htmltextview.HtmlTextView#setHtml(String)
     */
    ...
    /**
     * <a href="http://stackoverflow.com/questions/309424/read-convert-an-inputstream-to-a-string">http://stackoverflow.com/questions/309424/read-convert-an-inputstream-to-a-string</a>
     */
    @NonNull
